...
#### [04-2 TCP와 UDP](chapters/04-2_tcp_and_udp.md)
- TCP 통신 단계와 세그먼트 구조
  - 제어 비트
  - 순서 번호와 확인 응답 번호
- TCP 연결 수립과 종료
...
#### [05-3 HTTP 헤더와 HTTP 기반 기술](chapters/05-3_http_headers_and_technologies.md)
- HTTP 헤더
  - 요청 시 활용되는 HTTP 헤더
  - 응답 시 활용되는 HTTP 헤더
...
#### [07-3 무선 네트워크](chapters/07-3_wireless_network.md)
- 전파와 주파수
- 와이파이와 802.11
- AP와 서비스 셋
- 9가지 키워드로 정리하는 핵심 포인트
