...
1. 다음 중 네트워크 주소와 호스트 주소에 대한 설명으로 옳지 않은 것은?
   ...
   - [ ] 클래스풀 주소 체계에서는 모든 IP 주소의 네트워크 부분과 호스트 부분이 동일한 비트 수를 가진다
...
2. 다음 중 클래스리스 주소 체계(CIDR)의 특징으로 옳은 것은?
   ...
   - [ ] 네트워크 크기를 유연하게 조정할 수 있어 주소 공간을 효율적으로 사용할 수 있다
